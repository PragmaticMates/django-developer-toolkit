...
class DebugEmailForm(forms.Form):
    ...
    email_host_password = forms.CharField(initial=getattr(settings, 'EMAIL_HOST_PASSWORD', None), required=False)
    email_host_user = forms.CharField(initial=getattr(settings, 'EMAIL_HOST_USER', None), required=False)
